...
const MyProfile = () => {
  ...
  return (
    <div className='max:w-lg flex flex-col gap-2 text-sm'>
      ...
      {
        isEdit ?
          <input className='bg-gray-50 text-3xl mt-4 mx-w-60 font-medium' type="text" value={userData.name} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} />
